...
unittest {
    ...
    assert(isClose(res1.betas[0], 2.6623, 1e-2, 1e-2));
    assert(isClose(res1.betas[1], 0.2417, 1e-2, 1e-2));
    assert(isClose(res1.stdErr[0], 1.1008, 1e-2, 1e-2));
    assert(isClose(res1.stdErr[1], 0.0635, 1e-2, 1e-2));
    assert(isClose(res1.p[0], 0.0419, 1e-2, 1e-2));
    assert(isClose(res1.p[1], 0.0052, 1e-2, 1e-2));
    assert(isClose(res1.R2, 0.644, 1e-2, 1e-2));
    assert(isClose(res1.adjustedR2, 0.6001, 1e-2, 1e-2));
    assert(isClose(res1.residualError, 2.03, 1e-2, 1e-2));
    assert(isClose(res1.overallP, 0.00518, 1e-2, 1e-2));


    auto res2 = polyFit(weights, heights, 2);
    assert(isClose(res2.betas[0], 128.813, 1e-2, 1e-2));
    assert(isClose(res2.betas[1], -143.162, 1e-2, 1e-2));
    assert(isClose(res2.betas[2], 61.960, 1e-2, 1e-2));

    assert(isClose(res2.stdErr[0], 16.308, 1e-2, 1e-2));
    assert(isClose(res2.stdErr[1], 19.833, 1e-2, 1e-2));
    assert(isClose(res2.stdErr[2], 6.008, 1e-2, 1e-2));

    assert(isClose(res2.p[0], 4.28e-6, 1e-2, 1e-2));
    assert(isClose(res2.p[1], 1.06e-5, 1e-2, 1e-2));
    assert(isClose(res2.p[2], 2.57e-7, 1e-2, 1e-2));

    assert(isClose(res2.R2, 0.9989, 0.0001, 1e-2));
    assert(isClose(res2.adjustedR2, 0.9987, 0.0001, 1e-2));

    assert(isClose(res2.lowerBound[0], 92.9, 0.01, 1e-2));
    assert(isClose(res2.lowerBound[1], -186.8, 0.01, 1e-2));
    assert(isClose(res2.lowerBound[2], 48.7, 0.01, 1e-2));
    assert(isClose(res2.upperBound[0], 164.7, 0.01, 1e-2));
    assert(isClose(res2.upperBound[1], -99.5, 0.01, 1e-2));
    assert(isClose(res2.upperBound[2], 75.2, 0.01, 1e-2));
    ...
    assert(isClose(res4.p, 3.604e-14, 1e-2, 1e-2));
    assert(isClose(res4.betas, [-39.062, 61.272], 1e-2, 1e-2));
    assert(isClose(res4.p, [6.05e-9, 3.60e-14], 1e-2, 1e-2));
    assert(isClose(res4.R2, 0.9892, 1e-2, 1e-2));
    assert(isClose(res4.adjustedR2, 0.9884, 1e-2, 1e-2));
    assert(isClose(res4.residualError, 0.7591, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound, [-45.40912, 57.43554], 1e-2, 1e-2));
    assert(isClose(res4.upperBound, [-32.71479, 65.10883], 1e-2, 1e-2));
    ...
    assert(isClose(ridge1, [6.0357757, -0.2729671, -0.1337131], 1e-2, 1e-2));
    assert(isClose(ridge2, [5.62367784, -0.22449854, -0.09775174], 1e-2, 1e-2));
    assert(isClose(ridge3, [5.82653624, -0.05197246, -0.27185592 ], 1e-2, 1e-2));
}
...
unittest {
    ...
    assert(isClose(res1.betas[0], -0.98273, 1e-2, 1e-2));
    assert(isClose(res1.betas[1], 0.01219, 1e-2, 1e-2));
    assert(isClose(res1.stdErr[0], 1.80803, 1e-2, 1e-2));
    assert(isClose(res1.stdErr[1], 0.29291, 1e-2, 1e-2));
    assert(isClose(res1.p[0], 0.587, 1e-2, 1e-2));
    assert(isClose(res1.p[1], 0.967, 1e-2, 1e-2));
    assert(isClose(res1.aic, 12.374, 1e-2, 1e-2));
    assert(isClose(res1.logLikelihood, -0.5 * 8.3758, 1e-2, 1e-2));
    assert(isClose(res1.nullLogLikelihood, -0.5 * 8.3740, 1e-2, 1e-2));
    assert(isClose(res1.lowerBound[0], -4.5264052, 1e-2, 1e-2));
    assert(isClose(res1.lowerBound[1], -0.5618933, 1e-2, 1e-2));
    assert(isClose(res1.upperBound[0], 2.560939, 1e-2, 1e-2));
    assert(isClose(res1.upperBound[1], 0.586275, 1e-2, 1e-2));
    ...
    assert(isClose(res2.betas[0], -1.1875, 1e-2, 1e-2));
    assert(isClose(res2.betas[1], 0.1021, 1e-2, 1e-2));
    assert(isClose(res2.betas[2], 0.1603, 1e-2, 1e-2));
    assert(isClose(res2.stdErr[0], 1.5430, 1e-2, 1e-2));
    assert(isClose(res2.stdErr[1], 0.2507, 1e-2, 1e-2));
    assert(isClose(res2.stdErr[2], 0.2108, 1e-2, 1e-2));
    assert(isClose(res2.p[0], 0.442, 1e-2, 1e-2));
    assert(isClose(res2.p[1], 0.684, 1e-2, 1e-2));
    assert(isClose(res2.p[2], 0.447, 1e-2, 1e-2));
    assert(isClose(res2.aic, 21.81, 1e-2, 1e-2));
    assert(isClose(res2.nullLogLikelihood, -0.5 * 16.636, 1e-2, 1e-2));
    assert(isClose(res2.logLikelihood, -0.5 * 15.810, 1e-2, 1e-2));
    assert(isClose(res2.lowerBound[0], -4.2116584, 1e-2, 1e-2));
    assert(isClose(res2.lowerBound[1], -0.3892603, 1e-2, 1e-2));
    assert(isClose(res2.lowerBound[2], -0.2528110, 1e-2, 1e-2));
    assert(isClose(res2.upperBound[0], 1.8366823, 1e-2, 1e-2));
    assert(isClose(res2.upperBound[1], 0.5934631, 1e-2, 1e-2));
    assert(isClose(res2.upperBound[2], 0.5733693, 1e-2, 1e-2));
    ...
    assert(isClose(res3.betas[0], 1.115e0, 1e-2, 1e-2));
    assert(isClose(res3.betas[1], -4.674e-15, 1e-2, 1e-2));
    assert(isClose(res3.betas[2], -7.026e-9, 1e-2, 1e-2));
    assert(isClose(res3.betas[3], -2.109e-12, 1e-2, 1e-2));
    assert(isClose(res3.stdErr[0], 1.158, 1e-2, 1e-2));
    assert(isClose(res3.stdErr[1], 2.098e-13, 1e-2, 1e-2));
    assert(isClose(res3.stdErr[2], 1.878e-8, 1e-2, 1e-2));
    assert(isClose(res3.stdErr[3], 4.789e-11, 1e-2, 1e-2));
    assert(isClose(res3.p[0], 0.336, 1e-2, 1e-2));
    assert(isClose(res3.p[1], 0.982, 1e-2, 1e-2));
    assert(isClose(res3.p[2], 0.708, 1e-2, 1e-2));
    assert(isClose(res3.p[3], 0.965, 1e-2, 1e-2));
    assert(isClose(res3.aic, 12.544, 1e-2, 1e-2));
    assert(isClose(res3.nullLogLikelihood, -0.5 * 11.0904, 1e-2, 1e-2));
    assert(isClose(res3.logLikelihood, -0.5 * 4.5442, 1e-2, 1e-2));
    ...
    assert(isClose(res4.betas[0], -1.574, 1e-2, 1e-2));
    assert(isClose(res4.betas[1], 5.625e-6, 1e-2, 1e-2));
    assert(isClose(res4.betas[2], -7.282e-1, 1e-2, 1e-2));
    assert(isClose(res4.betas[3], -4.381e-6, 1e-2, 1e-2));
    assert(isClose(res4.betas[4], -8.343e-6, 1e-2, 1e-2));
    assert(isClose(res4.stdErr[0], 3.693e-2, 1e-2, 1e-2));
    assert(isClose(res4.stdErr[1], 7.188e-8, 1e-2, 1e-2));
    assert(isClose(res4.stdErr[2], 4.208e-2, 1e-2, 1e-2));
    assert(isClose(res4.stdErr[3], 1.658e-3, 1e-2, 1e-2));
    assert(isClose(res4.stdErr[4], 8.164e-4, 1e-2, 1e-2));
    assert(isClose(res4.p[0], 0));
    assert(isClose(res4.p[1], 0));
    assert(isClose(res4.p[2], 0, 1e-2, 1e-2));
    assert(isClose(res4.p[3], 0.998, 1e-2, 1e-2));
    assert(isClose(res4.p[4], 0.992, 1e-2, 1e-2));
    assert(isClose(res4.aic, 1089339, 1e-2, 1e-2));
    assert(isClose(res4.nullLogLikelihood, -0.5 * 1386294, 1e-2, 1e-2));
    assert(isClose(res4.logLikelihood, -0.5 * 1089329, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound[0], -1.668899, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound[1], 5.439787e-6, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound[2], -0.8366273, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound[3], -4.27406e-3, 1e-2, 1e-2));
    assert(isClose(res4.lowerBound[4], -2.111240e-3, 1e-2, 1e-2));
    assert(isClose(res4.upperBound[0], -1.478623, 1e-2, 1e-2));
    assert(isClose(res4.upperBound[1], 5.810089e-6, 1e-2, 1e-2));
    assert(isClose(res4.upperBound[2], -6.198418e-1, 1e-2, 1e-2));
    assert(isClose(res4.upperBound[3], 4.265302e-3, 1e-2, 1e-2));
    assert(isClose(res4.upperBound[4], 2.084554e-3, 1e-2, 1e-2));

    // Test ridge stuff.
    auto ridge2 = logisticRegressBeta(y2, repeat(1), x2_1, x2_2, 3);
    assert(isClose(ridge2[0], -0.40279319, 1e-2, 1e-2));
    assert(isClose(ridge2[1], 0.03575638, 1e-2, 1e-2));
    assert(isClose(ridge2[2], 0.05313875, 1e-2, 1e-2));

    auto ridge2_2 = logisticRegressBeta(y2, repeat(1), x2_1, x2_2, 2);
    assert(isClose(ridge2_2[0], -0.51411490, 1e-2, 1e-2));
    assert(isClose(ridge2_2[1], 0.04536590, 1e-2, 1e-2));
    assert(isClose(ridge2_2[2], 0.06809964, 1e-2, 1e-2));
}
